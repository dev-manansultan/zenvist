...
const NEXT_PUBLIC_AUTH_REDIRECT_URL = process.env.NEXT_PUBLIC_AUTH_REDIRECT_URL;
...
export const env = {
  ...
  get authRedirectUrl() {
    return requiredValue(NEXT_PUBLIC_AUTH_REDIRECT_URL, "NEXT_PUBLIC_AUTH_REDIRECT_URL");
  },
